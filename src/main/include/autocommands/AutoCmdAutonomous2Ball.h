...
class AutoCmdAutonomous2Ball
    : public frc2::CommandHelper<frc2::SequentialCommandGroup, AutoCmdAutonomous2Ball> {
 public:
  AutoCmdAutonomous2Ball(SubLimelightShooter* subLimelightShooter, SubShooter* subShooter, SubIntake* subIntake, SubDriveTrain* subDriveTrain, frc::Timer* timer);
};
